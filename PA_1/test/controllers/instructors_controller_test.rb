...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { email: @instructor.email, first_name: @instructor.first_name, lsat_name: @instructor.lsat_name, middle_name: @instructor.middle_name } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { email: @instructor.email, first_name: @instructor.first_name, lsat_name: @instructor.lsat_name, middle_name: @instructor.middle_name } }
